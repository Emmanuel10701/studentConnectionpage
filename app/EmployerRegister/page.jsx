...
import { FaUser, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaBriefcase, FaBuilding, FaPhone, FaGlobe } from 'react-icons/fa';
...
const EmployerRegister = () => {
  ...
  const [data, setData] = useState({
    name: "", email: "", password: "", confirmPassword: "", companyName: "", companySize: "",
    industry: "", phone: "", website: "", position: ""
  });
  ...
  const handleSubmit = async (event) => {
    ...
    const res = await fetch("/api/employer/route.js", {
      method: "POST",
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <motion.div variants={itemVariants}>
              ...
              <select value={data.companySize} onChange={(e) => setData({ ...data, companySize: e.target.value })}
                ...
                <option value="51-200">51-200 employees</option><option value="201-500">201-500 employees</option>
                <option value="501-1000">501-1000 employees</option><option value="1000+">1000+ employees</option>
              </select>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <select value={data.industry} onChange={(e) => setData({ ...data, industry: e.target.value })}
                ...
                <option value="Manufacturing">Manufacturing</option><option value="Retail">Retail</option>
                <option value="Consulting">Consulting</option><option value="Government">Government</option>
            ...
            <motion.div variants={itemVariants}>
              <label className="block text-sm font-medium text-gray-700 mb-2">
                <FaGlobe className="inline mr-2 text-green-600" />Company Website
              </label>
              <input type="url" placeholder="https://company.com" value={data.website}
