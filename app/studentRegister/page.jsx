...
const StudentRegister = () => {
  ...
  useEffect(() => {
    const { name, email, password, confirmPassword, institution, course, yearOfStudy } = data;
    setIsValid(
      name.trim() !== "" &&
      email.trim() !== "" &&
      password.trim() !== "" &&
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-blue-100 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <motion.div className="text-center mb-8" variants={itemVariants}>
          ...
          <p className="text-gray-600">Join our community of empowered students</p>
        </motion.div>
        ...
        <motion.form className="bg-white rounded-2xl shadow-xl p-8" variants={containerVariants}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <motion.div variants={itemVariants}>
              ...
              <select value={data.yearOfStudy} onChange={(e) => setData({ ...data, yearOfStudy: e.target.value })}
                ...
                <option value="5">5th Year</option><option value="6">6th Year</option>
          ...
          <motion.div variants={itemVariants} className="mt-4 flex items-center">
            ...
            <label htmlFor="agree" className="text-sm text-gray-700">
              I agree to all the <a href="/terms" className="text-blue-600 underline" target="_blank">terms and conditions</a>
            </label>
          </motion.div>
